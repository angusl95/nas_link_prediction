...
OPS = {
  ...
  'avg_pool_3x3' : lambda C, stride, emb_dim, affine, dropout=0: nn.Sequential(
    nn.AvgPool2d(3, stride=stride, padding=1, count_include_pad=False),
    Stack(repeats=4)
    ),
  'max_pool_3x3' : lambda C, stride, emb_dim, affine, dropout=0: nn.Sequential(
  ...
  'sep_conv_7x7' : lambda C, stride, emb_dim, affine, dropout=0: SepConv(C, 4*C, 7, stride, 3, affine=affine, dropout=dropout),
  'dil_conv_3x3' : lambda C, stride, emb_dim, affine, dropout=0: DilConv(C, 4*C, 3, stride, 2, 2, affine=affine, dropout=dropout),
  'dil_conv_5x5' : lambda C, stride, emb_dim, affine, dropout=0: DilConv(C, 4*C, 5, stride, 4, 2, affine=affine, dropout=dropout),
  'conv_3x3'     : lambda C, stride, emb_dim, affine, dropout=0: Conv(C, 4*C, 3, stride, 1, affine=affine, dropout=dropout),
  'conv_5x5'     : lambda C, stride, emb_dim, affine, dropout=0: Conv(C, 4*C, 5, stride, 2, affine=affine, dropout=dropout),
  'conv_7x7'     : lambda C, stride, emb_dim, affine, dropout=0: Conv(C, 4*C, 7, stride, 3, affine=affine, dropout=dropout),
  'conv_1x5'     : lambda C, stride, emb_dim, affine, dropout=0: Conv(C, 4*C, (1,5), (stride,stride), (0,2), affine=affine, dropout=dropout),
  'conv_5x1'     : lambda C, stride, emb_dim, affine, dropout=0: Conv(C, 4*C, (5,1), (stride,stride), (2,0), affine=affine, dropout=dropout),
